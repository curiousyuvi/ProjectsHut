        ...
        <div className="flex flex-row justify-between">
          <div>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full px-4 items-center block hover:scale-95 duration-300 gap-2 justify-center text-center text-white from-indigo-500 via-purple-500 to-pink-500 bg-gradient-to-r  xl:text-[1rem] md:text-[0.8rem]  rounded-md py-2"
            >
